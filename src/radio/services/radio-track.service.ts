...
const KEY = {
  ACTIVE: 'radio:track:active',
  STAGED: 'radio:track:staged',
  IDX: 'radio:track:idx',
  META: 'radio:track:meta',
  STAGED_META: 'radio:track:staged:meta',
} as const
...
@Injectable()
export class RadioTrackService {
  private readonly logger = new Logger(RadioTrackService.name)
